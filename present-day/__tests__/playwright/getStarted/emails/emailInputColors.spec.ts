...
test("add a crimson border if the email is under the minimum length pre @ symbol", async ({
  page,
}) => {
...
test("add a crimson border if the domain is under the minimum length", async ({
  page,
}) => {
...
test("add a crimson border if the email is over or equal to the maximum length", async ({
  page,
}) => {
